...
namespace Exodrifter.UnityPython {
	...
	{
		public static ScriptEngine CreateEngine(string[] namespaces, IDictionary<string, object> options = null)
		{
			...
			{
				foreach (var assembly in GetAssembliesInNamespace(nameSpace))
				{
